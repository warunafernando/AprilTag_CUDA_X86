...
struct TransformLineFitPoint {
  __host__ __device__ __forceinline__ TransformLineFitPoint(
      const uint8_t *decimated_image_device, int decimated_width_in,
      int decimated_height_in)
      : decimated_image_device_(decimated_image_device),
        decimated_width(decimated_width_in),
        decimated_height(decimated_height_in) {}
